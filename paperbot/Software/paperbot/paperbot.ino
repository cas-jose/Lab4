...
void loop() {
    ...
    File f = SPIFFS.open("/TurnAnglesTest.txt", "r");
    ...
    else
    {
         for (int i = 0; i < 27; i++)
         {
          ...
          String alpha = f.readStringUntil ('\n');
          angleArray[i] = alpha.toFloat();       
